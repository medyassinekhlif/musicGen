...
**Output**: MIDI files with melody, harmony, and bass across 5 genres (classical, jazz, rock, electronic, blues)
...
<img src="assets/labs.png" alt="Spitfire LABS" width="200" align="right">
...
# Generate all genres
for genre in ['classical', 'jazz', 'rock', 'electronic', 'blues']:
